...
ax.plot(t.flatten(), x_pred.flatten(), y_pred.flatten(), color="crimson", lw=2, label="PINN")
ax.plot(t.flatten(), x_true.flatten(), y_true.flatten(), color="gray", lw=1, linestyle="--", label="Ground Truth")
